...
$= \frac{1}{r}\frac{\partial }{\partial \theta}(0)-\frac{\partial
}{\partial z}(\omega r)$

$= -\frac{\partial}{\partial z}(\omega r)$
...
$ = \frac{\partial}{\partial z}(0)-\frac{\partial}{\partial r}(0)$
...
$= \frac{1}{r}\frac{\partial}{\partial r}(r*\omega r) -
\frac{1}{r}\frac{\partial}{\partial \theta}(0)$

$= \frac{1}{r}\frac{\partial}{\partial r}(r^{2}\omega)$
...
$= \frac{1}{r}\frac{\partial}{\partial r}(r*\omega R^{2}/r) -
\frac{1}{r}\frac{\partial}{\partial \theta}(0)$
...
plot(r1,w1,
		...
		xlab = "Radius (r)",
		ylab = "Vorticity (w)")
lines(r2,w2,col="blue",typ="l",lty=2)
...
plot(r1,v1,
		...
		xlab = "Radius (r)",
		ylab = "Vorticity (w)")
lines(r2,v2,col="blue",typ="l",lty=2)
