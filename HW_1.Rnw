...
Using intuition, academic references, the internet, or any other resource to find appropriate fluid (i.e., density, , and viscosity, ) and 
ow (i.e., characteristic length and velocity L and U) properties, calculate approximate Reynolds numbers Re = UL= for the following systems:
